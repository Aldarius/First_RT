...
/*   Updated: 2019/07/31 21:26:33 by lminta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	boring_function(t_snuffbox *m_s, t_xy *pxl1, t_steep_grad *sg, int x)
{
...
static void	draw_while(t_snuffbox *m_s, t_xy *pxl1, t_xy *pxl2, t_steep_grad *sg)
{
	int		x;
	t_color	gr;
